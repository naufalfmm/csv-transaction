...
import (
	...
	orm "github.com/naufalfmm/csv-transaction/utils/orm"
...
// AppendColumns mocks base method.
func (m *MockSelect) AppendColumns(fmter schema.Formatter, b []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AppendColumns", fmter, b)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AppendColumns indicates an expected call of AppendColumns.
func (mr *MockSelectMockRecorder) AppendColumns(fmter, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendColumns", reflect.TypeOf((*MockSelect)(nil).AppendColumns), fmter, b)
}
...
func (m *MockSelect) Copy() orm.Select {
	m.ctrl.T.Helper()
...
func (mr *MockSelectMockRecorder) Copy() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Copy", reflect.TypeOf((*MockSelect)(nil).Copy))
}
...
// AppendColumns mocks base method.
func (m *MockValues) AppendColumns(fmter schema.Formatter, b []byte) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AppendColumns", fmter, b)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
...
// AppendColumns indicates an expected call of AppendColumns.
func (mr *MockValuesMockRecorder) AppendColumns(fmter, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendColumns", reflect.TypeOf((*MockValues)(nil).AppendColumns), fmter, b)
}
